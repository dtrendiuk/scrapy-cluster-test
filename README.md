...
***
	...
	c) create a directory in /root/ for Diffie-Hellman key:
# mkdir /root/dhparam
Generate the key with the openssl command:
...
(from this moment will describe the actions for DEV, but all the same should be workng for PROD as well)
